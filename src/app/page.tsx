...
export default function Home() {
  ...
  return (
    <>
      ...
      {/* Only show main content if Coming Soon page is not active */}
      {!comingSoonPageOpen && (
        <>
          {introVisible && (
            <div 
              className={`fixed inset-0 z-50 bg-white overflow-hidden flex items-center justify-center transition-opacity duration-1000 cursor-pointer ${fadeOut ? 'opacity-0' : 'opacity-100'}`}
