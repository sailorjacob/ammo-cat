...
export default function Home() {
  ...
  // Handler for all link/button clicks in shop
        ...
        <div className="flex flex-col min-h-screen bg-white text-black px-4 py-8 md:px-8 md:py-12">
          <main className="flex-grow flex flex-col items-start justify-center max-w-3xl mx-auto">
            ...
            <button 
              ...
              className="text-xl border-2 border-black px-8 py-3 hover:bg-black hover:text-white transition-colors ml-2"
            >
              Learn more
            </button>
          </main>
          ...
          <footer className="mt-auto pt-8">
            <p className="text-center text-gray-600">
              ©{new Date().getFullYear()} Ammo Cat. All rights reserved.
            </p>
          </footer>
        </div>
      ) : (
        // Original content (the shop) shown after clicking "Learn more"
